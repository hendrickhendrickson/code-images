...
export class Collection<K extends PropertyKey, I> {
	...
	public reduce(func: (value: I, item: I, index: number, items: I[]) => I, startValue?: I): I;

	public reduce<T>(func: (value: T, item: I, index: number, items: I[]) => T, startValue: T): T;
	...
	public reduce<T>(
		...
		if (startValue !== undefined) {
			...
			return this.items()
				.filter((_, index) => index !== 0) // TODO Quatsch
